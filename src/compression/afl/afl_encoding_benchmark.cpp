...
BENCHMARK_REGISTER_F(AflEncodingBenchmark, BM_Afl_Random_Int_Encode)->Arg(1<<22)->Arg(1<<23)->Arg(1<<26);
...
BENCHMARK_REGISTER_F(AflEncodingBenchmark, BM_Afl_Random_Int_Decode)->Arg(1<<22)->Arg(1<<23)->Arg(1<<26);
