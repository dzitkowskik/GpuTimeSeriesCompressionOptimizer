...
BENCHMARK_REGISTER_F(AflEncodingBenchmark, BM_Afl_Random_Int_Encode)->Arg(1<<15)->Arg(1<<20)->Arg(1<<26);
...
BENCHMARK_REGISTER_F(AflEncodingBenchmark, BM_Afl_Random_Int_Decode)->Arg(1<<15)->Arg(1<<20)->Arg(1<<26);
