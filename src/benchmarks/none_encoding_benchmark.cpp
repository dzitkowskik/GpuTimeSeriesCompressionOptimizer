...
BENCHMARK_REGISTER_F(NoneEncodingBenchmark, BM_None_Random_Int_Encode)->Arg(1<<15)->Arg(1<<20);
...
BENCHMARK_REGISTER_F(NoneEncodingBenchmark, BM_None_Random_Int_Decode)->Arg(1<<15)->Arg(1<<20);
...
BENCHMARK_REGISTER_F(NoneEncodingBenchmark, BM_None_Random_Float_Encode)->Arg(1<<15)->Arg(1<<20);
...
BENCHMARK_REGISTER_F(NoneEncodingBenchmark, BM_None_Random_Float_Decode)->Arg(1<<15)->Arg(1<<20);
